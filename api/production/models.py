...
class Recipe(models.Model):
    ...
    product = models.OneToOneField(
        Product, on_delete=models.CASCADE, null=True, blank=True, related_name="recipe"
    )
...
class ProductionRun(models.Model):
    ...
    composite_ingredient = models.ForeignKey(
        "inventory.Ingredient", on_delete=models.CASCADE, null=True, blank=True
    )
...
class IngredientUsage(models.Model):
    ...
    production_run = models.ForeignKey(
        ProductionRun, on_delete=models.CASCADE, related_name="usages"
    )
    ingredient = models.ForeignKey("inventory.Ingredient", on_delete=models.PROTECT)
