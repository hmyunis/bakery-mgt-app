...
from .serializers import IngredientSerializer, PurchaseSerializer, StockAdjustmentSerializer
...
class IngredientViewSet(viewsets.ModelViewSet):
    ...
    def shopping_list(self, request):
        ...
        """
        low_stock_items = Ingredient.objects.filter(current_stock__lte=F('reorder_point'))
...
class PurchaseViewSet(viewsets.ModelViewSet):
    queryset = Purchase.objects.select_related('ingredient', 'purchaser').order_by('-purchase_date')
