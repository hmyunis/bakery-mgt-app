...
from .models import Ingredient, Purchase, StockAdjustment, UnitChoices

class IngredientSerializer(serializers.ModelSerializer):
    class Meta:
        model = Ingredient
        fields = '__all__'
        read_only_fields = ('current_stock', 'average_cost_per_unit', 'last_purchased_price', 'updated_at')
