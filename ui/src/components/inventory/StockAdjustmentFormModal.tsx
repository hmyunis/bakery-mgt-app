...
import { useIngredients, useCreateStockAdjustment } from "../../hooks/useInventory";
...
export function StockAdjustmentFormModal({
    ...
    // We use a key to force the inner component to re-mount when the modal opens
    // or when the preselected ingredient changes. This ensures form state is reset cleanly.
    const formKey = preselectedIngredient ? `adjust-${preselectedIngredient.id}` : "adjust-new";
