        ...
        try {
            if (isEdit) {
                ...
                if (avatarFile) {
                    ...
                    setAvatarRemoved(false); // Reset removal flag if new file is uploaded
                    ...
                    <>
                        ...
                        <ModalBody className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="flex flex-col items-center pt-4">
                                ...
                                {errors.avatar && (
                                    <p className="text-sm text-danger mt-1">{errors.avatar}</p>
                                )}
                            </div>
                        ...
                        <ModalFooter>
                            <Button variant="flat" onPress={onCloseModal} disabled={isLoading}>
                                Cancel
                            </Button>
