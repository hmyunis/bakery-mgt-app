import { Button, Card, CardBody, CardHeader, Chip, Divider, Switch, Tooltip } from "@heroui/react";
import { useQuery } from "@tanstack/react-query";
import { Globe2, Loader2, Moon, Palette, Sparkles, Sun, LogIn } from "lucide-react";
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
                            {isAuthenticated ? (
                                ...
                                <>
                                    ...
                                    <Button
                                        variant="bordered"
                                        className="border-[var(--fg)]/20 text-[var(--fg)]"
                                    >
                                        {t("ctaSecondary")}
                                    </Button>
                                </>
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        {Object.entries(accents).map(([key, value]) => (
                                            <button
                                                ...
                                                aria-label={key}
                                                onClick={() =>
                                                    dispatch(setAccent(key as keyof typeof accents))
                                                }
